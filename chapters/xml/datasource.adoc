...
[source,xml]
----
include::{sourcedir}/examples/datasources/DataSource-GeoJSON.xml[]
----
image::examples/datasources/DataSource-GeoJSON.svg[align="center"]
====
...
[source,xml]
----
include::{sourcedir}/examples/datasources/DataSource-Shape.xml[]
----
image::examples/datasources/DataSource-Shape.svg[align="center"]
====
